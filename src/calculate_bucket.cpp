...
std::pair<Bits, Bits> F1Calculator::CalculateBucket(const Bits& L) const
{
...
std::pair<Bits, Bits> FxCalculator::CalculateBucket(const Bits& y1, const Bits& L, const Bits& R) const
{
    Bits input;
